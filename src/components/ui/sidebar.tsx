...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex items-center border-b border-sidebar-border p-2", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex items-center border-t border-sidebar-border p-2", className)}
      {...props}
    />
  )
})
...
>(({ className, open, onOpenChange, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
      data-collapsible={open !== undefined ? (open ? "open" : "closed") : undefined}
